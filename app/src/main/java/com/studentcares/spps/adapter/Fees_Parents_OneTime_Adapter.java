...
public class Fees_Parents_OneTime_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public Fees_Parents_OneTime_Adapter(List<Fees_Items> items) {
...
//            Fees_Parents_OneTime_Adapter.EmptyViewHolder emptyViewHolder = new Fees_Parents_OneTime_Adapter.EmptyViewHolder(v);
//            return emptyViewHolder;
//        }
        v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.fees_tab_parents_unpaid_onetime_items, viewGroup, false);
        viewHolder = new Fees_Parents_OneTime_Adapter.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof Fees_Parents_OneTime_Adapter.ViewHolder) {
            Fees_Parents_OneTime_Adapter.ViewHolder vHolder = (Fees_Parents_OneTime_Adapter.ViewHolder) viewHolder;
...
//                Intent gotoPaidfeesDetails = new Intent(v.getContext(), P_Fees_Unpaid_Details.class);
