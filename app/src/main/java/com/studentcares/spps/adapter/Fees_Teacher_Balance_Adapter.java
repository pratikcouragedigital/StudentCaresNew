...
public class Fees_Teacher_Balance_Adapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Fees_Teacher_Balance_Adapter(List<Fees_Items> items, FloatingActionButton attendanceCheckFab, FloatingActionButton mainFabBtn) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (i == VIEW_TYPE_EMPTY) {
            ...
            Fees_Teacher_Balance_Adapter.EmptyViewHolder emptyViewHolder = new Fees_Teacher_Balance_Adapter.EmptyViewHolder(v);
            return emptyViewHolder;
        }
        v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.fees_tab_teacher_balance_list_items, viewGroup, false);
        viewHolder = new Fees_Teacher_Balance_Adapter.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof Fees_Teacher_Balance_Adapter.ViewHolder) {
            Fees_Teacher_Balance_Adapter.ViewHolder vHolder = (Fees_Teacher_Balance_Adapter.ViewHolder) viewHolder;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements CompoundButton.OnCheckedChangeListener {
        ...
        public void bindListDetails(Fees_Items listItems) {
            ...
            balance.setText(listItems.getbalanceFess());
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            String balance= listItems.getbalanceFess();
            String msg = "Dear Parents Most respectfully it is stated that an amount of " +balance+ " Rupees is pending of your child "+studentName+". We earnestly request you to kindly settle the payment as early as possible so that your child can smoothly continue his studies.";
    ...
    public class EmptyViewHolder extends RecyclerView.ViewHolder {
        public EmptyViewHolder(View v) {
            ...
            emptyTextView.setText("Student list not available for this standard,division.please select another standard & division to get balance fees student list.");
        }
    }
}