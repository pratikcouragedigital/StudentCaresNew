...
public class PTA_Mem_Adapter_Secondary extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    CounterFab fabSendMsg_Notification;
    private TourGuide mTourGuideHandler;
    int count=0;
    int selectedIdCount = 0;

    public PTA_Mem_Adapter_Secondary(List<PTA_Member_Items> items, CounterFab fabSendMsg_Notification) {
...
//        return listFilteredItem.size();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
        ...
        public ViewHolder(View itemView) {
            ...
            cardView = itemView;
            contactNo.setOnClickListener(this);
        ...
        public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            ...
            if(isChecked) {
                ...
                fabSendMsg_Notification.setCount(selectedIdCount);
