...
public class SMS_Attendance_List_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public SMS_Attendance_List_Adapter(List<SMS_Inbox_Items> items) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (i == VIEW_TYPE_EMPTY) {
            ...
            SMS_Attendance_List_Adapter.EmptyViewHolder emptyViewHolder = new SMS_Attendance_List_Adapter.EmptyViewHolder(v);
            return emptyViewHolder;
        }
        v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.sms_inbox_list_items, viewGroup, false);
        viewHolder = new SMS_Attendance_List_Adapter.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof SMS_Attendance_List_Adapter.ViewHolder) {
            SMS_Attendance_List_Adapter.ViewHolder vHolder = (SMS_Attendance_List_Adapter.ViewHolder) viewHolder;
...
//        return listItems.size();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void bindListDetails(SMS_Inbox_Items listItems) {
            ...
            date.setText(listItems.getDate()+" "+listItems.gettime());
            msgBody.setText(listItems.getmsgBody());

            txtMsgType.setVisibility(View.GONE);
