...
public class Leave_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Leave_Adapter(List<Leave_Items> items) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        if (i == VIEW_TYPE_EMPTY) {
            ...
            Leave_Adapter.EmptyViewHolder emptyViewHolder = new Leave_Adapter.EmptyViewHolder(v);
            return emptyViewHolder;
        }
        v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.leave_list_items, viewGroup, false);
        viewHolder = new Leave_Adapter.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        if (viewHolder instanceof Leave_Adapter.ViewHolder) {
            Leave_Adapter.ViewHolder vHolder = (Leave_Adapter.ViewHolder) viewHolder;
...
//        return listItems.size();
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void bindListDetails(Leave_Items listItems) {
            ...
            if (isApprovedOrNot == true) {
                ...
                txtApproveBy.setBackgroundColor(v.getResources().getColor(R.color.colorGreen500));
            } else {

                layoutApproveBy.setVisibility(View.VISIBLE);
                txtApproveBy.setText("Not Approved Yet");
                txtApproveBy.setBackgroundColor(v.getResources().getColor(R.color.attAbsentMark));
            }
    ...
    public class EmptyViewHolder extends RecyclerView.ViewHolder {
        public EmptyViewHolder(View v) {
            ...
            emptyTextView.setText("No leave yet applied.");
