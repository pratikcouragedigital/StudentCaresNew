...
public class Homework_List_Adapter_Teacher extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public Homework_List_Adapter_Teacher(List<Homework_Items> yaatraItems) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.homework_list_items_t, viewGroup, false);
...
//// to set image we need to convert from string
//            String imageString = listItems.getFirstImagePath();
//
//            if(!imageString.equals("") || imageString == null || imageString.equals("null")){
//                byte[] decodedString = Base64.decode(imageString, Base64.DEFAULT);
//                Bitmap decodedByte = BitmapFactory.decodeByteArray(decodedString, 0, decodedString.length);
//                homeworkImage.setImageBitmap(decodedByte);
//            }else {
//                // set defaul image
//            }
        }
...
//                Intent petFullInformation = new Intent(v.getContext(), T_Homework_Show_Details.class);
...
//
    public class EmptyViewHolder extends RecyclerView.ViewHolder {
        public EmptyViewHolder(View v) {
            ...
            emptyTextView.setText("Homework List Not Available For This Std & Div, You Can Change Std & Div Using Below Button.");
        }
    }
}
