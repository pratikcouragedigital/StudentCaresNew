...
public class Attendance_Staff_Absent_List_Adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public Attendance_Staff_Absent_List_Adapter(List<Attendance_List_Items> items, FloatingActionButton attendanceStaffCheckFab) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        ...
        v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.attendance_tab_staff_absent_items, viewGroup, false);
        viewHolder = new Attendance_Staff_Absent_List_Adapter.ViewHolder(v);
        return viewHolder;
    }
    ...
    public int getItemCount() {
        ...
        attendanceCount.setcountAbsent_Staff(countP);
    ...
    public class EmptyViewHolder extends RecyclerView.ViewHolder {
        public EmptyViewHolder(View v) {
            ...
            emptyTextView.setText("Today's Absent Staff List Not Available.");
        }
    }
}
