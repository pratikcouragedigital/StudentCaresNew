...
public class Leave_List_Own extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new Leave_Adapter(listItems);
    ...
    private void getList(){
        try {
            ...
            leave_req.OwnLeaveList(listItems, recyclerView, adapter,schoolId,userId,progressDialog);
