...
import com.studentcares.spps.adapter.SMS_Attendance_List_Adapter;
...
public class SMS_InBox_Tab_Attendance extends Fragment implements View.OnClickListener{
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        reviewAdapter = new SMS_Attendance_List_Adapter(listItems);
    ...
    private void getList(int current_page, String selectedDate) {
        try {
            ...
            if(selectedDate.equals("")){
                getList.GetAttendanceSMSList(listItems, recyclerView, reviewAdapter,userId, schoolId,userType, current_page,progressDialog);
            }else{
                getList.GetAttendanceSMSListDateWise(listItems, recyclerView, reviewAdapter,userId, schoolId,userType, current_page,selectedDate,progressDialog);
            }
