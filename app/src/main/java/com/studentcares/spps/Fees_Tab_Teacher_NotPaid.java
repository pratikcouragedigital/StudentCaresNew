...
import com.studentcares.spps.adapter.Fees_Teacher_NotPaid_Adapter;
...
public class Fees_Tab_Teacher_NotPaid extends Fragment implements View.OnClickListener, HideFabButton {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v = inflater.inflate(R.layout.fees_tab_teacher_not_paid_list, container, false);
        hideFabButton = this;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        adapter = new Fees_Teacher_NotPaid_Adapter(fees_Items,sendSMSFab,mainFabBtn);
    ...
    private void getList(){
        ...
        try {
            Fees_Get_Details_Teacher _Fees_Get__DetailsTeacher = new Fees_Get_Details_Teacher(getActivity());
            _Fees_Get__DetailsTeacher.NotPaid_FeesDetails(fees_Items, recyclerView, adapter, schoolId, standardId,divisionId,progressDialog);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
            ...
            alert.setPositiveButton("Submit", new DialogInterface.OnClickListener() {
                public void onClick(DialogInterface dialog, int whichButton) {
                    if (standardName == null || standardName.isEmpty()) {
                        ...
                        Fees_Tab_Teacher_Balance.hideFabButton.hideFab(true);
    ...
    public void EnterMessage() {
        ...
        final EditText txtMsg = new EditText(getActivity());
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(RelativeLayout.LayoutParams.MATCH_PARENT, RelativeLayout.LayoutParams.WRAP_CONTENT);
