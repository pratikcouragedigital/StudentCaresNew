package com.studentcares.spps.imageModule;
...
public class Image {
    ...
    public Image(News_Add UANews_add, String activityName, OnRecyclerSetImageListener onRecyclerSetImageListener) {
        this.activity = UANews_add;
        this.activityName = activityName;
        this.onRecyclerSetImageListener = onRecyclerSetImageListener;
    }

    public Image(Notice_Add UANotice_add, String activityName, OnRecyclerSetImageListener onRecyclerSetImageListener) {
        this.activity = UANotice_add;
        this.activityName = activityName;
        this.onRecyclerSetImageListener = onRecyclerSetImageListener;
    }
    //
    public Image(Homework_Add_Teacher _homework_addT, String activityName, OnRecyclerSetImageListener onRecyclerSetImageListener) {
        this.activity = _homework_addT;
        this.activityName = activityName;
        this.onRecyclerSetImageListener = onRecyclerSetImageListener;
    }

    public Image(Notice_Add_Teacher notice_add_teacher, String notice, OnRecyclerSetImageListener onRecyclerSetImageListener) {
        this.activity = notice_add_teacher;
        this.activityName = notice;
        this.onRecyclerSetImageListener = onRecyclerSetImageListener;
    }

    public Image(Gallery_Event_Images_Add gallery_event_images_add, String gallery, OnRecyclerSetImageListener onRecyclerSetImageListener) {
    ...
    public interface OnRecyclerSetImageListener {
        ...
        void onRecyclerImageSet(Bitmap imageToShow, String firstImagePath);
    }
...
//                }
    ...
    private void setBitmapToImage(Bitmap imageToShow) {
        if (imageBase64String == "") {
            ...
            onRecyclerSetImageListener.onRecyclerImageSet(imageToShow, imageBase64String);
        }
